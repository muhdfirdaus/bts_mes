...
<html>
  <head>
    ...
    <title>SN Register | <?php include('../dist/includes/title.php');?></title>
                ...
                <form id="form_box" class="form-horizontal" method="post" action="carton_in.php" enctype='multipart/form-data'>
                  ...
                  <table class="table table-bordered table-striped">
                    <thead>
                      ...
                      <th class="info text-center">PCBA S/N</th>
                      <th class="info text-center">Boxbuild S/N</th>
                    </thead>
                    <tbody>
